...
- `registry.ts` preserves IDs across builds, Git-confirmed file moves, and unambiguous one-to-one structural matches;
...
either side and re-running the sync — never hand-edit the JSON.
