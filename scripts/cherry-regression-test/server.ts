...
const locatorInputSchema = {
  ...
  properties: {
    ...
    role: { description: 'ARIA role. Combine with name or text to identify one control.', type: 'string' },
    name: { description: 'Accessible name, usually paired with role.', type: 'string' },
