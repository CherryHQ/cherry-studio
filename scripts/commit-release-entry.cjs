...
if (current.object.sha !== process.env.GITHUB_SHA)
  throw new Error(
    'Source branch changed during release; keep the previous release entry until artifacts are reconciled'
  )
const body = {
  ...
  variables: {
    input: {
      ...
      message: {
        ...
        body: 'Signed-off-by: Travis James <travis@know-me.tools>\n\nAssisted-by: Codex:GPT-6 [GitHub Actions release packaging]'
      },
      fileChanges: {
