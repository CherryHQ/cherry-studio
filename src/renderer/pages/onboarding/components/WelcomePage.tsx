...
const WelcomePage: FC<WelcomePageProps> = ({ setStep, setCherryInLoggedIn, previewMode }) => {
  ...
  }, [previewMode, provider, updateProvider, addModel, setCherryInLoggedIn, setStep, t])
