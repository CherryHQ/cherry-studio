export const paintingClasses = {
  ...
  tabsList:
    'rounded-full border border-border-muted bg-neutral-100 p-1 shadow-[var(--painting-surface-shadow)] backdrop-blur-sm dark:bg-muted/40',
  tabsTrigger:
  ...
  surface:
    'relative isolate flex min-w-0 flex-1 overflow-hidden rounded-[var(--painting-radius-surface)] bg-background',
  ...
  panel:
    'painting-theme-portal flex h-full w-[var(--painting-panel-width)] shrink-0 flex-col overflow-hidden border-border-subtle border-r bg-[var(--painting-panel-bg)]',
  ...
  historyAddButton:
    'sticky top-0 z-10 mb-1 flex h-9 w-11 shrink-0 items-center justify-center rounded-full bg-background text-muted-foreground hover:bg-[var(--painting-control-bg-hover)] hover:text-foreground',
  historyItem:
  ...
  toolbarRail:
    'flex items-center rounded-full border border-border-muted bg-background/90 p-1 shadow-[var(--painting-floating-shadow)] backdrop-blur-xl',
