export const paintingClasses = {
  ...
  tabsList: 'rounded-full border border-border-subtle bg-neutral-100 p-1 shadow-sm backdrop-blur-sm dark:bg-muted/40',
  tabsTrigger:
  ...
  historyAddButton:
    'sticky top-0 z-10 mb-1 flex h-11 w-11 shrink-0 items-center justify-center rounded-[12px] border border-dashed border-border-subtle bg-background text-muted-foreground hover:bg-black/10 hover:text-foreground dark:hover:bg-white/20',
  historyItem:
    'group relative flex h-11 w-11 shrink-0 items-center justify-center overflow-visible rounded-[12px] bg-secondary p-0 leading-none transition hover:bg-black/10 dark:hover:bg-white/20',
  historyItemActive: 'bg-background',
  historyDelete:
    'absolute -top-1 -right-1 z-20 flex size-5 cursor-pointer items-center justify-center rounded-full border border-border-subtle bg-white/95 text-destructive opacity-0 shadow-sm transition group-hover:opacity-100 dark:bg-background/95',
  promptModeTabsList: 'h-8 rounded-full border border-border-subtle bg-muted/35 p-0.5 shadow-none dark:bg-muted/20',
