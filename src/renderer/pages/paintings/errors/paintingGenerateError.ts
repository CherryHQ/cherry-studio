...
export function translatePaintingGenerateError(error: Error): string {
  ...
  const keyMap: Record<Exclude<PaintingGenerateErrorCode, 'REMOTE_ERROR'>, string> = {
    ...
    IMAGE_OUTPUT_EMPTY: 'paintings.image_output_empty',
    IMAGE_OUTPUT_INVALID: 'paintings.image_output_invalid',
    IMAGE_OUTPUT_UNSUPPORTED: 'paintings.image_output_unsupported',
