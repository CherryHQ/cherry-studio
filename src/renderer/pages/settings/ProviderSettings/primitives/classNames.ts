...
export const drawerClasses = {
  ...
  /** Chip face of a native radio input; the input itself is `sr-only peer`. */
  endpointRadioChip:
    'inline-flex h-7 cursor-pointer items-center gap-1.5 rounded-md border border-border px-2.5 text-foreground text-xs transition-colors hover:bg-accent peer-focus-visible:ring-2 peer-focus-visible:ring-ring peer-focus-visible:ring-offset-1 peer-focus-visible:ring-offset-background',
