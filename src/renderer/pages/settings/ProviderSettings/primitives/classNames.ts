...
export const modelSyncClasses = {
  ...
  manageTabsList: 'h-auto w-full max-w-full justify-start gap-1 overflow-x-auto rounded-lg bg-muted/40 p-1',
  manageTabsTrigger: 'h-7 shrink-0 gap-1.5 rounded-md px-2 text-xs',
