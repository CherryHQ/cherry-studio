...
export const modelSyncClasses = {
  ...
  fetchList: 'space-y-1',
  fetchWarning:
    'my-2 gap-2 rounded-lg [--model-sync-warning-accent:oklch(0.83_0.164_84)] border-[color:color-mix(in_srgb,var(--model-sync-warning-accent)_35%,transparent)] bg-[color:color-mix(in_srgb,var(--warning-subtle)_52%,transparent)] px-2.5 py-2 text-xs leading-tight shadow-none [&_[data-ui~="part:alert-icon"]]:mt-0 [&_[data-ui~="part:alert-icon"]_svg]:size-3.5 [&_[data-ui~="part:alert-message"]]:font-normal',
  fetchRowNew:
