...
export const modelListClasses = {
  ...
  rowAvatar:
    'inline-flex size-6 shrink-0 items-center justify-center overflow-hidden rounded-lg [&_*]:overflow-hidden [&_*]:rounded-[inherit] [&_img]:rounded-[inherit] [&_svg]:rounded-[inherit]',
