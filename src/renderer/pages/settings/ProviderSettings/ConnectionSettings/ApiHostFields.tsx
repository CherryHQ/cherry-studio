...
interface ReasoningFormatFieldProps {
  ...
  value: (ProviderReasoningFormat | ProviderReasoningFormatSelector) | undefined
  onCommit: (reasoningFormat: ProviderReasoningFormatSelector | undefined) => void
}
  ...
  return (
    <ProviderField
      ...
      <Select value={selectedValue} onValueChange={handleValueChange}>
        <SelectTrigger size="sm" className="w-full max-w-65" aria-label={t('settings.provider.reasoning_format')}>
          <SelectValue />
        </SelectTrigger>
