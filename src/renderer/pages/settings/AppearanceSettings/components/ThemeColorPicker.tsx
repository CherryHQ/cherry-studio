...
const ThemeColorPicker = ({ value, presets, onChange, ariaLabel, className }: ThemeColorPickerProps) => {
  ...
  const handlePickerChange = ([red, green, blue]: [number, number, number, number]) => {
      ...
      <Popover>
        <PopoverTrigger asChild>
          <button
            ...
            className="relative flex h-8 w-8 shrink-0 cursor-pointer items-center justify-center rounded-md border border-border bg-background shadow-xs outline-none focus-visible:border-ring">
