      ...
      {open && (
        <div className="fixed inset-0 z-50 bg-background">
          <button
            type="button"
            onClick={handleClose}
            className="absolute top-4 left-4 z-10 flex items-center gap-1 rounded-md bg-secondary px-3 py-2 text-secondary-foreground text-sm shadow-sm hover:bg-secondary-hover">
            <X size={14} />
