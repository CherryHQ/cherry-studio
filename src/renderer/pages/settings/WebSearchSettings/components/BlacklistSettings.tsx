    ...
    <SettingGroup theme={theme}>
      ...
      <div className="mt-3">
        <div className="space-y-2">
          <div className="text-(length:--font-size-body-xs) flex items-center gap-2 text-foreground-muted leading-(--line-height-body-xs)">
          ...
          <div className="relative">
            <Textarea.Input
              ...
              className="text-(length:--font-size-body-xs) placeholder:text-(length:--font-size-body-2xs) max-h-40 min-h-28 rounded-lg pr-20 leading-(--line-height-body-xs) shadow-none"
              rows={4}
            />
            {blacklistDirty && (
              <Button
