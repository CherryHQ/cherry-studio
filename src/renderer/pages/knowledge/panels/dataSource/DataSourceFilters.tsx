    ...
    <div className="flex items-center gap-2">
      {dataSourceFilterDefinitions.map(({ labelKey, value: filterValue }) => (
        <Button
          ...
          variant="ghost"
          className={cn(
            'h-auto min-h-0 rounded bg-transparent px-1.5 py-px font-normal leading-4 shadow-none transition-colors',
            value === filterValue
              ? 'font-medium text-foreground hover:bg-accent/40 hover:text-foreground'
