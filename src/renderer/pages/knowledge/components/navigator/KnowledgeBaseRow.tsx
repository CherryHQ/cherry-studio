...
import { ArrowRightLeft, FolderPlus, MoreHorizontal, PencilLine, Trash2 } from 'lucide-react'
          ...
          <div
            ...
            <CommandPopupMenu
              ...
              <Button
                ...
                className={cn(
                  'text-foreground/80 hover:bg-accent group-focus-within/kb:opacity-100 group-focus-within:opacity-100 group-hover/kb:opacity-100 group-hover:opacity-100',
