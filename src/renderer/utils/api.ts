import { formatApiHost, isBareVertexApiHost, withoutTrailingSlash, SUPPORTED_ENDPOINT_LIST } from '@shared/utils/api'
...
export const SUPPORTED_ENDPOINT_LIST = [...SUPPORTED_IMAGE_ENDPOINT_LIST, 'chat/completions', 'responses', 'messages', 'generateContent', 'streamGenerateContent'] as const
