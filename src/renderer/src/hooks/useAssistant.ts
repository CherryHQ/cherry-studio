...
import { setDefaultModel, setTopicNamingModel, setTranslateModel, setVisionModel } from '@renderer/store/llm'
...
export function useDefaultModel() {
  const { defaultModel, topicNamingModel, translateModel, visionModel } = useAppSelector((state) => state.llm)
  const dispatch = useAppDispatch()
