...
import AbacusLogo from '@renderer/assets/images/apps/abacus.jpg?url'
...
import DifyAppLogo from '@renderer/assets/images/apps/dify.jpg?url'
...
import WPSLingXiLogo from '@renderer/assets/images/apps/wpslingxi.jpg?url'
