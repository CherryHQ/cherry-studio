/**
 * FileManager.uploadFile v2 cutover tests.
 *
 * Asserts that after the cutover:
 * - uploadFile routes to window.api.file.createInternalEntry (v2 IPC)
 * - uploadFile does NOT call the legacy window.api.file.upload
 * - uploadFile does NOT call db.files.add / db.files.update
 * - The returned value is a FileMetadata-shaped object
 */

import { beforeEach, describe, expect, it, vi } from 'vitest'

// Mock db — no IndexedDB in jsdom
...
const mockEntry = {
  id: '018f1234-5678-7000-8000-000000000010',
