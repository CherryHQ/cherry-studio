...
import type { UsePaintingPageReturn } from '../hooks/usePaintingPage'
import Artboard, { type ArtboardProps } from './Artboard'
import PaintingPromptBar from './PaintingPromptBar'
import PaintingsList from './PaintingsList'

export interface PaintingPageShellProps {
  pageState: UsePaintingPageReturn<any>
