export const paintingClasses = {
  ...
  promptDock: 'shrink-0 border-border/60 border-t bg-background px-2 pt-2 pb-2',
  panel:
  ...
  historyStrip:
    'flex h-full w-[68px] shrink-0 flex-col gap-2 overflow-y-auto border-border/50 border-l bg-background px-2 py-3 [scrollbar-width:none] [-ms-overflow-style:none] [&::-webkit-scrollbar]:hidden',
  historyAddButton:
  ...
  toolbarRail:
    'flex items-center rounded-full border border-border/60 bg-background/90 p-1 shadow-[var(--painting-floating-shadow)] backdrop-blur-xl',
