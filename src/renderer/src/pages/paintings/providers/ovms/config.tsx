...
export type ConfigItem = {
  ...
  content?: string
  disabled?: boolean | ((config: ConfigItem, painting: Partial<PaintingData>) => boolean)
  initialValue?: string | number | boolean
  required?: boolean
  condition?: (painting: PaintingData) => boolean
}
...
export const createDefaultOvmsPainting = (models?: Array<{ label: string; value: string }>): PaintingData => {
  const availableModels = models || OVMS_MODELS
  return {
