...
const PopupContainer: React.FC<Props> = ({ resolve }) => {
  ...
  const labelWidth = [t('agents.add.name.key'), t('agents.add.prompt.key'), t('agents.add.knowledge_base.key')]
  ...
  return (
    <Modal
      ...
      <Form
        ...
        <Form.Item name="name" label={t('agents.add.name.key')} rules={[{ required: true }]}>
          <Input placeholder={t('agents.add.name.placeholder')} spellCheck={false} allowClear />
        </Form.Item>
        <div style={{ position: 'relative' }}>
          <Form.Item
            name="prompt"
            label={t('agents.add.prompt.key')}
            rules={[{ required: true }]}
        ...
        {showKnowledgeIcon && (
          <Form.Item name="knowledge_base_ids" label={t('agents.add.knowledge_base.key')} rules={[{ required: false }]}>
            <Select
              mode="multiple"
              allowClear
