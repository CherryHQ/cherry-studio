...
import { Dispatch, forwardRef, memo, SetStateAction, useCallback, useEffect, useMemo, useRef, useState } from 'react'
...
const MessageItem = forwardRef<HTMLDivElement, Props>(
  (
    {
      message: _message,
      topic: _topic,
