...
import { Alert, Button, Checkbox, Input, InputNumber, Segmented, Select, Tooltip, Typography } from 'antd'
    ...
    <Container theme={theme}>
      ...
      <ConfigurationField>
        <NetworkAccessRow>
          ...
          <Switch checked={apiGatewayConfig.exposeToNetwork} onCheckedChange={handleExposeToNetworkChange} />
        </NetworkAccessRow>
