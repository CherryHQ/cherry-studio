    ...
    <>
      ...
      {hasObjectKey(provider, 'basicAuthUsername') && (
        <>
          ...
          <SettingSubtitle style={{ marginTop: 5, marginBottom: 10 }}>
            {t('settings.provider.basic_auth.key')}
          ...
          <Flex>
            <Form
              ...
              <Form.Item label={t('settings.provider.basic_auth.user_name.key')} name="username">
                <Input
              ...
              <Form.Item
                label={t('settings.provider.basic_auth.password.key')}
                name="password"
