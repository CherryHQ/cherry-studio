      ...
      <div className="flex flex-wrap gap-1.5">
        {selectedItems.map((item) => (
          <div
            ...
            <span className="max-w-[160px] truncate font-medium text-emerald-600 text-sm leading-tight dark:text-emerald-400">
              {item.label}
            </span>
        ...
        <Popover open={open} onOpenChange={setOpen}>
          <PopoverTrigger asChild>
            <Button
              ...
              variant="outline"
              size="sm"
              className="h-auto rounded-lg border-foreground/15 border-dashed px-2.5 py-[4px] text-foreground/35 text-sm leading-tight shadow-none hover:border-foreground/25 hover:bg-transparent hover:text-foreground/55">
              <Plus size={9} />
                  ...
                  {options.map((option) => {
                    ...
                    return (
                      <CommandItem
                        ...
                        className="gap-2 rounded-md px-2 py-1.5 text-sm">
