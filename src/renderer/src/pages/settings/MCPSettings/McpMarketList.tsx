...
const MarketCard = ({ className, ...props }: React.ComponentPropsWithoutRef<'div'>) => (
  <div
    className={cn(
      'flex h-20 cursor-pointer flex-col rounded-lg border border-border bg-card px-4 py-3 transition-all hover:border-primary hover:shadow-[0_2px_8px_rgba(0,0,0,0.1)]',
      className
    )}
    {...props}
  />
