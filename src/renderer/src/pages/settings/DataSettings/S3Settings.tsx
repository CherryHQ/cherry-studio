...
const S3Settings: FC = () => {
  ...
  return (
    <SettingGroup theme={theme}>
      ...
      <SettingDivider />
      <SettingRow>
        <SettingRowTitle>{t('settings.data.s3.endpoint.key')}</SettingRowTitle>
        <Input
      ...
      <SettingDivider />
      <SettingRow>
        <SettingRowTitle>{t('settings.data.s3.region.key')}</SettingRowTitle>
        <Input
      ...
      <SettingDivider />
      <SettingRow>
        <SettingRowTitle>{t('settings.data.s3.bucket.key')}</SettingRowTitle>
        <Input
      ...
      <SettingDivider />
      <SettingRow>
        <SettingRowTitle>{t('settings.data.s3.accessKeyId.key')}</SettingRowTitle>
        <Input
      ...
      <SettingDivider />
      <SettingRow>
        <SettingRowTitle>{t('settings.data.s3.secretAccessKey.key')}</SettingRowTitle>
        <Input.Password
      ...
      <SettingDivider />
      <SettingRow>
        <SettingRowTitle>{t('settings.data.s3.root.key')}</SettingRowTitle>
        <Input
      ...
      <SettingDivider />
      <SettingRow>
        <SettingRowTitle>{t('settings.data.s3.autoSync.key')}</SettingRowTitle>
        <Selector
          size={14}
          value={syncInterval}
      ...
      <SettingDivider />
      <SettingRow>
        <SettingRowTitle>{t('settings.data.s3.maxBackups.key')}</SettingRowTitle>
        <Selector
          size={14}
          value={maxBackups}
      ...
      <SettingDivider />
      <SettingRow>
        <SettingRowTitle>{t('settings.data.s3.skipBackupFile.key')}</SettingRowTitle>
      ...
      {syncInterval > 0 && (
        <>
          <SettingDivider />
          <SettingRow>
            <SettingRowTitle>{t('settings.data.s3.syncStatus.key')}</SettingRowTitle>
            {renderSyncStatus()}
          </SettingRow>
        </>
      )}
