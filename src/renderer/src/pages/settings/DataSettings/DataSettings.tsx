        ...
        {menu === 'data' && (
          <>
            ...
            <SettingGroup theme={theme}>
              ...
              <SettingDivider />
              <SettingRow>
                <SettingRowTitle>{t('settings.data.app_data.key')}</SettingRowTitle>
                <PathRow>
              ...
              <SettingDivider />
              <SettingRow>
                <SettingRowTitle>{t('settings.data.app_logs.key')}</SettingRowTitle>
                <PathRow>
              ...
              <SettingDivider />
              <SettingRow>
                <SettingRowTitle>{t('settings.data.app_knowledge.key')}</SettingRowTitle>
