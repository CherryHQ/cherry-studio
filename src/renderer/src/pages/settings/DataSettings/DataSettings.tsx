...
const DataSettings: FC = () => {
  ...
  const JoplinIcon = () => (
    <svg viewBox="0 0 24 24" width="16" fill="var(--color-icon)" xmlns="http://www.w3.org/2000/svg">
  ...
  const SiyuanIcon = () => (
    <svg viewBox="0 0 1024 1024" version="1.1" xmlns="http://www.w3.org/2000/svg" p-id="2962" width="16">
      <path
