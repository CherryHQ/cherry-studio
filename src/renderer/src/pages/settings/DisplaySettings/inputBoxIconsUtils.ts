...
function createSpecialIcons() {
  return {
    ...
    token_count: React.createElement('div', { 
      style: { 
        fontSize: 11, 
        padding: '3px 10px', 
...
export function getInputBoxIcons(): InputBoxIconInfo[] {
  ...
  const leftIconsConfig = [
    ...
    { id: 'thinking', order: 3, condition: 'showThinkingButton', name: '思考模式', tooltip: 'assistants.settings.reasoning_effort', visible: true },
    ...
    { id: 'mention_models', order: 8, condition: 'always', name: '提及模型', tooltip: 'agents.edit.model.select.title', visible: true },
    ...
    { id: 'token_count', order: 13, condition: 'showInputEstimatedTokens', name: 'Token计数', tooltip: 'Token计数', visible: true }
  ]
