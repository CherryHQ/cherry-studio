  ...
  return (
    <SettingContainer theme={theme}>
      ...
      <SettingGroup theme={theme}>
        ...
        <SettingDivider />
        <SettingRow>
          <SettingRowTitle>{t('settings.display.navbar.position.key')}</SettingRowTitle>
          <Segmented
      ...
      <SettingGroup theme={theme}>
        ...
        <SettingDivider />
        <SettingRow>
          <SettingRowTitle>{t('settings.topic.position.key')}</SettingRowTitle>
          <Segmented
      ...
      <SettingGroup theme={theme}>
        ...
        <SettingDivider />
        <SettingRow>
          <SettingRowTitle>{t('settings.assistant.icon.type.key')}</SettingRowTitle>
          <Segmented
      ...
      <SettingGroup theme={theme}>
        <SettingTitle>
          {t('settings.display.custom.css.key')}
