...
const DetailHeader = ({ base, onRenameBase, onDeleteBase }: DetailHeaderProps) => {
        ...
        <div className="flex min-w-0 items-center gap-2">
          ...
          <div className="flex min-w-0 items-center gap-1.5">
            ...
            <div className="flex shrink-0 items-center gap-1">
              <span aria-hidden="true" className={cn('size-1.5 rounded-full', statusDotClassNames[DEFAULT_STATUS])} />
              <span className={cn('text-[0.5625rem] leading-3.375', statusTextClassNames[DEFAULT_STATUS])}>
