    ...
    <div className="flex w-full min-w-0 shrink-0 flex-col gap-2 overflow-hidden border-border/15 border-t px-4 py-2.5">
      {errorMessage ? (
        <div
          role="alert"
          title={errorMessage}
          className="wrap-break-word max-h-16 w-full min-w-0 overflow-y-auto whitespace-pre-wrap rounded-md border border-destructive/40 bg-accent/30 px-2 py-1 text-[11px] text-destructive leading-4">
          {errorMessage}
        </div>
      ) : null}
