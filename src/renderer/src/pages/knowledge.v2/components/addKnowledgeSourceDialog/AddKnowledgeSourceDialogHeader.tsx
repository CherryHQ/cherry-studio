...
interface AddKnowledgeSourceDialogHeaderProps {
  closeLabel: string
  title: string
}

const AddKnowledgeSourceDialogHeader = ({ closeLabel, title }: AddKnowledgeSourceDialogHeaderProps) => {
  return (
...
export default AddKnowledgeSourceDialogHeader
