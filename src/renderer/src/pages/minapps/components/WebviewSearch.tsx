...
const WebviewSearch: FC<WebviewSearchProps> = ({ webviewRef, isWebviewReady, appId }) => {
  ...
  return (
    <div className="pointer-events-auto absolute end-3 top-3 z-50 flex items-center gap-2 rounded-xl border border-default-200 bg-background px-2 py-1 shadow-lg">
      <Input
        ref={inputRef}
        autoFocus
        value={query}
