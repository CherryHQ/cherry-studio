...
import type { LegacyWebSearchProvider, Model } from '@renderer/types'
...
export interface WebSearchState {
  ...
  // 所有可用的搜索提供商列表
  providers: LegacyWebSearchProvider[]
  // 是否在搜索查询中添加当前日期
...
const websearchSlice = createSlice({
  ...
  reducers: {
    ...
    // },
    // setWebSearchProviders: (state, action: PayloadAction<LegacyWebSearchProvider[]>) => {
    //   state.providers = action.payload
    // },
    // updateWebSearchProviders: (state, action: PayloadAction<LegacyWebSearchProvider[]>) => {
    //   state.providers = action.payload
    // },
    // updateWebSearchProvider: (state, action: PayloadAction<Partial<LegacyWebSearchProvider>>) => {
    ...
    // },
    // addWebSearchProvider: (state, action: PayloadAction<LegacyWebSearchProvider>) => {
