...
const PopupContainer: React.FC<Props> = ({ title, provider, resolve, model, endpointType }) => {
  ...
  return (
    <Modal
      ...
      <Form
        form={form}
        labelCol={{ style: { width: useDynamicLabelWidth([t('settings.models.add.endpoint_type.key')]) } }}
        labelAlign="left"
        colon={false}
        style={{ marginTop: 25 }}
        onFinish={onFinish}
        ...
        <Form.Item
          name="id"
          label={t('settings.models.add.model_id.key')}
        ...
        <Form.Item
          name="name"
          label={t('settings.models.add.model_name.key')}
          tooltip={t('settings.models.add.model_name.placeholder')}>
          <Input placeholder={t('settings.models.add.model_name.placeholder')} spellCheck={false} />
        </Form.Item>
        <Form.Item
          name="group"
          label={t('settings.models.add.group_name.key')}
          tooltip={t('settings.models.add.group_name.tooltip')}>
          <Input placeholder={t('settings.models.add.group_name.placeholder')} spellCheck={false} />
        </Form.Item>
        <Form.Item
          name="endpointType"
          label={t('settings.models.add.endpoint_type.key')}
