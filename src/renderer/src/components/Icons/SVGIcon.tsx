...
export function OpenClawIcon(props: SVGProps<SVGSVGElement>) {
  return (
    <svg
      ...
      {...props}>
      {/* Left antenna */}
      <path d="M8 5 Q5 2 3 3" />
      {/* Right antenna */}
      <path d="M16 5 Q19 2 21 3" />
      {/* Body outline */}
      <path d="M12 4 C7 4 4 8 4 12 C4 16 7 20 10 21 L10 23 M14 21 C17 20 20 16 20 12 C20 8 17 4 12 4" />
      {/* Middle leg */}
      <path d="M12 20 L12 23" />
      {/* Right leg */}
      <path d="M14 21 L14 23" />
      {/* Left claw */}
      <path d="M4 10 C1 9 0 11 1 13 C2 15 4 14 5 12" />
      {/* Right claw */}
      <path d="M20 10 C23 9 24 11 23 13 C22 15 20 14 19 12" />
      {/* Eyes - filled circles */}
