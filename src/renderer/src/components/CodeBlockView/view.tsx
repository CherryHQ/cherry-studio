...
export const CodeBlockView: React.FC<Props> = memo(({ children, language, onSave }) => {
  ...
  useEffect(() => {
    ...
    if (codeEditor.enabled) {
      registerTool({
        ...
        tooltip: viewMode === 'source' ? t('code_block.preview.key') : t('code_block.edit.key'),
      ...
      registerTool({
        ...
        tooltip: viewMode === 'source' ? t('code_block.preview.key') : t('code_block.preview.source'),
        onClick: () => setViewMode(viewMode === 'source' ? 'special' : 'source')
      })
    }
  ...
  useEffect(() => {
    ...
    registerTool({
      ...
      tooltip: viewMode === 'split' ? t('code_block.split.restore') : t('code_block.split.key'),
