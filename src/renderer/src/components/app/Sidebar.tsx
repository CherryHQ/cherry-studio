  ...
  return (
    <Container
      ...
      <Menus>
        ...
        <Tooltip content={t('settings.title')} delay={800} placement="right" showArrow={true}>
          <StyledLink
            onClick={async () => {
              hideMinappPopup()
...
const MainMenus: FC = () => {
  ...
  return sidebarIcons.visible.map((icon) => {
    ...
    return (
      <Tooltip key={icon} content={getSidebarIconLabel(icon)} delay={800} placement="right" showArrow={true}>
        <StyledLink
          onClick={async () => {
            hideMinappPopup()
            await modelGenerating()
