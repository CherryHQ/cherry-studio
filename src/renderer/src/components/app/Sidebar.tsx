...
import { sidebarIconLabelMap, themeModeLabelMap } from '@renderer/i18n/labelMap'
  ...
  return (
    <Container
      ...
      <Menus>
        ...
        <Tooltip
          title={t('settings.theme.title') + ': ' + themeModeLabelMap[theme]}
          mouseEnterDelay={0.8}
          placement="right">
...
const MainMenus: FC = () => {
  ...
  return sidebarIcons.visible.map((icon) => {
    ...
    return (
      <Tooltip key={icon} title={sidebarIconLabelMap[icon]} mouseEnterDelay={0.8} placement="right">
        <StyledLink
          onClick={async () => {
            hideMinappPopup()
            await modelGenerating()
