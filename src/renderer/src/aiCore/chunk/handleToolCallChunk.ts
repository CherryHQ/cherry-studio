...
// import { processKnowledgeReferences } from '@renderer/services/KnowledgeV2Service'
...
export class ToolCallChunkHandler {
  ...
  public handleToolResult(
    ...
    // Knowledge V2 tool post-processing is temporarily disabled while KnowledgeV2Service is removed.
    // // 工具特定的后处理
