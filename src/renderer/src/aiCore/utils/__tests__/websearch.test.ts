  ...
  describe('buildProviderBuiltinWebSearchConfig', () => {
    ...
    describe('edge cases', () => {
      it('should handle maxResults at boundary values', () => {
        ...
        const config33: WebSearchConfig = { searchWithTime: true, maxResults: 33, excludeDomains: [] }
        ...
        const config34: WebSearchConfig = { searchWithTime: true, maxResults: 34, excludeDomains: [] }
        ...
        const config66: WebSearchConfig = { searchWithTime: true, maxResults: 66, excludeDomains: [] }
        ...
        const config67: WebSearchConfig = { searchWithTime: true, maxResults: 67, excludeDomains: [] }
      ...
      it('should handle zero maxResults', () => {
        const config: WebSearchConfig = { searchWithTime: true, maxResults: 0, excludeDomains: [] }
        const result = buildProviderBuiltinWebSearchConfig('openai', config)
        expect(result?.openai?.searchContextSize).toBe('low')
      })

      it('should handle very large maxResults', () => {
        const config: WebSearchConfig = { searchWithTime: true, maxResults: 1000, excludeDomains: [] }
        const result = buildProviderBuiltinWebSearchConfig('openai', config)
