...
export function isOpenAIServiceTier(
  tier: string | null | undefined,
): tier is OpenAIServiceTier {
  return (
    tier === null ||
    tier === undefined ||
    Object.hasOwn(OpenAIServiceTiers, tier)
  );
}
...
export function isGroqServiceTier(
  tier: string | undefined | null,
): tier is GroqServiceTier {
  return (
    tier === null || tier === undefined || Object.hasOwn(GroqServiceTiers, tier)
  );
}
...
export const isGroqSystemProvider = (
  provider: Provider,
): provider is GroqSystemProvider => {
