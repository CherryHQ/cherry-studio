...
const SelectionActionContent: FC<{ action: SelectionActionItem }> = ({ action }) => {
  ...
  return (
    <div
      className="relative m-0.5 flex h-[calc(100%-6px)] w-[calc(100%-6px)] flex-col overflow-hidden rounded-lg border border-border bg-card shadow-[0_0_2px_var(--color-border)]"
