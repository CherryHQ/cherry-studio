...
interface OnboardingPageProps {
  /** Retained for source compatibility with embedders; Cherry account onboarding is no longer shown. */
...
export default function OnboardingPage(_props: OnboardingPageProps) {
