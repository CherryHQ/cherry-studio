 ...
 * via ConversationShell; this is only used for the rest. Provides the OS drag region +
 * macOS traffic-light inset + tab title + pin / back-to-main controls. Sits on the
 * sidebar-tinted window background so the framed content card below it reads as a floating
 * panel.
 */
