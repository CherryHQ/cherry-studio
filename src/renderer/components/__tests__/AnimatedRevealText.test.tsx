...
describe('AnimatedRevealText', () => {
  it('renders accessible single-layer text', () => {
    ...
    const root = container.querySelector('[data-ui~="part:animated-reveal-text"]')
  ...
  it('uses a custom aria label when provided', () => {
    ...
    expect(container.querySelector('[data-ui~="part:animated-reveal-text"]')).toHaveAttribute('aria-label', 'Greeting')
  })

  it('does not render blank text', () => {
    const { container } = render(<AnimatedRevealText text="   " />)

    expect(container.querySelector('[data-ui~="part:animated-reveal-text"]')).not.toBeInTheDocument()
  })
})
