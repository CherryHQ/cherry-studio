...
import { getSendMessageShortcutLabel, resolveNewlineShortcut, resolveSteerShortcut } from '@renderer/utils/input'
    ...
    () =>
      isStreaming
        ? t('agent.input.placeholder_streaming', {
            ...
            steerKey: getSendMessageShortcutLabel(resolvedSteerShortcut)
          })
