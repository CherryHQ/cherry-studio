...
export default function ComposerSurface({
  ...
  const inputbarElement = (
    <div
      ...
      className={cn(
        'inputbar-container relative rounded-[20px] border-[0.5px] border-border bg-[oklch(from_var(--card)_calc(l_-_0.015)_c_h/0.995)] transition-all duration-200 ease-in-out dark:bg-card',
