    ...
    onCreate: ({ editor: createdEditor }) => {
      ...
      setTimeoutTimer(
        ...
        () => {
          ...
          // An eagerly mounted runtime (restored draft after a topic/agent switch) must not steal
          // focus from wherever the user left it — restore only after real fallback interaction.
