  ...
  return (
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent
        ...
        <Command
          shouldFilter={false}
          className="min-h-0 flex-1 bg-card [&_[data-ui~='part:command-input']]:h-full [&_[data-ui~='part:command-input']]:py-0 [&_[data-ui~='part:command-input']]:text-foreground [&_[data-ui~='part:command-input']]:text-sm [&_[data-ui~='part:command-input-wrapper']>svg]:size-8 [&_[data-ui~='part:command-input-wrapper']>svg]:rounded-full [&_[data-ui~='part:command-input-wrapper']>svg]:bg-secondary [&_[data-ui~='part:command-input-wrapper']>svg]:p-2 [&_[data-ui~='part:command-input-wrapper']>svg]:text-foreground-muted [&_[data-ui~='part:command-input-wrapper']>svg]:opacity-100 [&_[data-ui~='part:command-input-wrapper']]:h-[38px] [&_[data-ui~='part:command-input-wrapper']]:flex-1 [&_[data-ui~='part:command-input-wrapper']]:gap-2.5 [&_[data-ui~='part:command-input-wrapper']]:border-b-0 [&_[data-ui~='part:command-input-wrapper']]:px-3">
