        ...
        <div className="flex items-center gap-1.5">
          ...
          <Tooltip content={settingsLabel} portalContainer={portalContainer ?? undefined}>
            <Button
              ...
              className="flex size-6 min-h-0 shrink-0 items-center justify-center rounded-md p-0 text-muted-foreground/80 shadow-none hover:bg-accent/50 hover:text-foreground focus-visible:bg-accent/50 focus-visible:text-foreground">
