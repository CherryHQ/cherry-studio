              ...
              <ModelSelector
                ...
                trigger={
                  <DialogModelTrigger
                    ...
                    chevronClassName={
                      allowClear && value
                        ? 'group-hover/model-field:opacity-0 group-focus-within/model-field:opacity-0 [@media(hover:none)]:opacity-0'
                        : undefined
                    }
                  />
                }
