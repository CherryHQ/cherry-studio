    ...
    <div className="space-y-1 px-2 py-2 [-webkit-app-region:no-drag]">
      {extensionsLabel && (
        <button
          type="button"
          onClick={onExtensionsClick}
          className="flex w-full items-center gap-2.5 rounded-lg px-2.5 py-1.75 text-sidebar-foreground text-sm transition-colors hover:bg-accent/60">
          <Columns2 size={16} />
      ...
      {user && (
        <div
          ...
          <div className="min-w-0 flex-1">
            <div className="truncate text-sidebar-foreground text-sm">{user.name}</div>
          </div>
