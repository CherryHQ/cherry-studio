...
export const MODEL_SELECTOR_ROW_CHECKBOX_CLASS =
  'border-subtle-foreground/40 hover:bg-muted/70 data-[state=checked]:border-subtle-foreground data-[state=checked]:bg-muted-foreground data-[state=checked]:text-background focus-visible:ring-muted-foreground/20'
