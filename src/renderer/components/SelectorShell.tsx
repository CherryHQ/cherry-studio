              ...
              {search ? (
                <div
                  ...
                  <div className="relative flex min-w-0 flex-1 items-center rounded-full border border-border-subtle bg-background">
                    <Search className="-translate-y-1/2 pointer-events-none absolute top-1/2 left-2.5 size-3.25 text-foreground-tertiary" />
                    <Input
                      type="text"
                    ...
                    {search.value ? (
                      <Button
                        ...
                        className="-translate-y-1/2 absolute top-1/2 right-0.5 size-[22px] rounded-full p-0 text-foreground-tertiary hover:bg-accent/40 hover:text-foreground"
