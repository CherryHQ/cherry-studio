...
import { useOptionalRightPanelState, useOptionalShellState } from '../panes/Shell'
...
export default function ConversationStageCenter(props: ConversationStageCenterProps) {
  ...
  const paneMaximized = presentationState?.presentationMaximized ?? shellState?.maximized ?? false
