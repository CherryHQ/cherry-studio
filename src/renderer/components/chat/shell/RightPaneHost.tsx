    ...
    <>
      ...
      {resizeHandleVisible && (
        <div
          ...
          className="group/right-pane-resize-handle absolute start-0 top-0 bottom-0 z-30 w-2 cursor-col-resize focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-primary/40">
