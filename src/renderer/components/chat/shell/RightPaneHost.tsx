    ...
    <>
      ...
      {resizeHandleVisible && (
        <div
          ...
          className="group/right-pane-resize-handle absolute top-0 bottom-0 left-0 z-30 w-2 cursor-col-resize focus-visible:bg-control-accent/40 focus-visible:outline-none">
