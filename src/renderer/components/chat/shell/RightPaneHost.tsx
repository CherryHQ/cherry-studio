    ...
    <>
      ...
      {resizeHandleVisible && (
        <div
          ...
          className="group/right-pane-resize-handle absolute start-0 top-0 bottom-0 z-30 w-2 cursor-col-resize focus-visible:bg-primary/40 focus-visible:outline-none">
