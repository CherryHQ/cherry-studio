...
const GROUP_HEADER_CHEVRON_SLOT_CLASS =
  '-ml-1.5 hidden size-6 shrink-0 items-center justify-center text-muted-foreground group-hover/resource-list-group:flex group-has-[:focus-visible]/resource-list-group:flex group-has-data-[state=open]/resource-list-group:flex [@media(hover:none)]:flex'
      ...
      <div
        ...
        <button
          ...
          <ChevronRight
            aria-hidden="true"
            size={14}
            className="hidden shrink-0 text-muted-foreground transition-transform duration-150 group-hover/resource-list-section:block group-has-[:focus-visible]/resource-list-section:block [@media(hover:none)]:block"
          ...
          <div
            className={cn(
              ...
              sectionHeaderActionAlwaysVisible
                ...
                : 'pointer-events-none opacity-0 group-hover/resource-list-section:pointer-events-auto group-hover/resource-list-section:opacity-100 has-[:focus-visible]:pointer-events-auto has-[:focus-visible]:opacity-100 [@media(hover:none)]:pointer-events-auto [@media(hover:none)]:opacity-100'
            )}>
            {sectionHeaderAction}
          </div>
        )}
      ...
      {groupHeaderAction && (
        <div
          className={cn(
            ...
            !hasLeadingSlot && '-mr-1',
            'group-hover/resource-list-group:pointer-events-auto group-hover/resource-list-group:grid-cols-[1fr] group-hover/resource-list-group:opacity-100 has-data-[state=open]:pointer-events-auto has-data-[state=open]:grid-cols-[1fr] has-data-[state=open]:opacity-100 group-has-[:focus-visible]/resource-list-group:pointer-events-auto group-has-[:focus-visible]/resource-list-group:grid-cols-[1fr] group-has-[:focus-visible]/resource-list-group:opacity-100 [@media(hover:none)]:pointer-events-auto [@media(hover:none)]:grid-cols-[1fr] [@media(hover:none)]:opacity-100'
          )}
          onClick={stopEventPropagation}
          onContextMenu={stopEventPropagation}
          onPointerDown={stopEventPropagation}
