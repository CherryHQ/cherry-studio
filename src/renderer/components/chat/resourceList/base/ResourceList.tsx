  ...
  return (
    <button
      ...
      className={cn(
        ...
        RESOURCE_LIST_ROW_STATE_FOREGROUND_CLASS,
        'group-hover:pointer-events-auto group-hover:opacity-100 data-[deleting=true]:pointer-events-auto data-[deleting=true]:opacity-100 aria-pressed:pointer-events-auto aria-pressed:opacity-100 [@media(hover:none)]:pointer-events-auto [@media(hover:none)]:opacity-100',
        className
      )}
      {...props}
    />
  ...
  return (
    <div
      ...
      className={cn(
        ...
        'focus-within:pointer-events-auto focus-within:grid-cols-[1fr] focus-within:opacity-100 group-hover:pointer-events-auto group-hover:grid-cols-[1fr] group-hover:opacity-100 data-[active=true]:pointer-events-auto data-[active=true]:grid-cols-[1fr] data-[active=true]:opacity-100 data-[pinned=true]:pointer-events-auto data-[pinned=true]:grid-cols-[1fr] data-[pinned=true]:opacity-100 [@media(hover:none)]:pointer-events-auto [@media(hover:none)]:grid-cols-[1fr] [@media(hover:none)]:opacity-100',
        className
      )}
      {...props}>
