    ...
    <StreamingContext value={isStreaming}>
      <div
        ...
        <div
          ...
          className={cn(
            'flex w-fit items-center justify-between gap-2 rounded-md px-2.5 py-2 text-left font-semibold text-foreground/90 text-sm leading-4 outline-none hover:no-underline focus-visible:bg-accent/50 disabled:pointer-events-none disabled:opacity-50',
