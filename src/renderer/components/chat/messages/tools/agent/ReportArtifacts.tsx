      ...
      {openPath && (
        <Tooltip content={t('chat.input.tools.open_file')} delay={500}>
          <button
            ...
            className="mr-2 flex size-7 shrink-0 items-center justify-center rounded-md text-muted-foreground opacity-70 transition-colors hover:bg-background hover:text-foreground hover:opacity-100">
