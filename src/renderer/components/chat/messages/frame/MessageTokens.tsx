...
const MessageTokens: React.FC<MessageTokensProps> = ({ message }) => {
  ...
  if (message.role === 'user') {
    return (
      <div
        className="message-tokens cursor-pointer select-text text-right text-[length:var(--font-size-body-xs)] text-foreground-secondary leading-[var(--line-height-body-xs)] hover:text-foreground"
