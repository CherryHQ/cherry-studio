      ...
      <div
        ...
        <div
          ...
          <div className="flex w-full min-w-0 items-center gap-1.5">
            ...
            <div
              className={`message-header-info-wrap flex shrink-0 items-center gap-1 text-[10px] text-foreground-tertiary leading-none opacity-0 transition-opacity duration-150 focus-within:opacity-100 [@media(hover:none)]:opacity-100 ${hiddenContentHoverClass}`}>
            ...
            {actionsSlot && (
              <div
                className={`message-header-actions pointer-events-none ml-auto flex shrink-0 items-center gap-1 opacity-0 transition-opacity duration-150 focus-within:pointer-events-auto focus-within:opacity-100 [@media(hover:none)]:pointer-events-auto [@media(hover:none)]:opacity-100 ${hiddenActionsHoverClass}`}>
                {actionsSlot}
              </div>
            )}
          </div>
