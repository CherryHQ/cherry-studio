...
describe('Shell.MaximizedOverlay', () => {
  it('exposes the measured composer safe area while keeping the maximized pane full height', async () => {
    ...
    await waitFor(() => {
      ...
      expect(content).not.toHaveStyle({ height: 'max(0px, calc(100% - 128px))' })
