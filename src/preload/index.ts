...
const api = {
  ...
  checkForBetaUpdate: () => ipcRenderer.invoke(IpcChannel.App_CheckForBetaUpdate),
  ...
  setCheckBetaUpdate: (isActive: boolean) =>
    ipcRenderer.invoke(IpcChannel.App_SetCheckBetaUpdate, isActive),
