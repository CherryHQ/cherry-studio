...
const api = {
  ...
  openclaw: {
    ...
    syncConfig: (provider: Provider, primaryModel: Model, visionModel?: Model): Promise<OperationResult> =>
      ipcRenderer.invoke(IpcChannel.OpenClaw_SyncConfig, provider, primaryModel, visionModel),
