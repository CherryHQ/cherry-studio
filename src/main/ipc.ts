...
export async function registerIpc() {
  ...
  ipcMain.handle(IpcChannel.File_LegacyOpen, fileManager.open.bind(fileManager))
  ...
  ipcMain.handle(IpcChannel.File_LegacyRead, fileManager.readFile.bind(fileManager))
  ...
  ipcMain.handle(IpcChannel.File_LegacyRename, fileManager.renameFile.bind(fileManager))
  ...
  ipcMain.handle(IpcChannel.File_LegacyWrite, fileManager.writeFile.bind(fileManager))
  ...
  ipcMain.handle(IpcChannel.File_LegacyCopy, fileManager.copyFile.bind(fileManager))
  ...
  ipcMain.handle(IpcChannel.File_LegacyListDirectory, fileManager.listDirectory.bind(fileManager))
  ...
  ipcMain.handle(IpcChannel.File_LegacyShowInFolder, fileManager.showInFolder.bind(fileManager))
