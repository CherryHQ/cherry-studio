...
export const networkRules: readonly ScanRule[] = [
  {
    ...
    anchors: [/ERR_CONNECTION_(?:REFUSED|CLOSED|RESET|TIMED_OUT)|ECONNREFUSED|ECONNRESET|socket hang up/]
  },
  {
    ...
    anchors: [/ERR_INTERNET_DISCONNECTED|ERR_NAME_NOT_RESOLVED|ENOTFOUND|EAI_AGAIN|ENETUNREACH/]
  },
  {
  ...
  },
  {
    ...
    anchors: [
      /\bETIMEDOUT\b|ERR_TIMED_OUT|HeadersTimeoutError|ConnectTimeoutError|UND_ERR_CONNECT_TIMEOUT|fetch failed/
    ],
    ...
    exclude: [
      /ECONNREFUSED|ECONNRESET|ERR_CERT_|ENOTFOUND|ERR_INTERNET_DISCONNECTED|ERR_CONNECTION_/,
      /fetch failed[^\n]{0,20}HTTP \d{3}/i
    ]
  }
]
