 ...
 * - cumulative actual bytes across manifest + DB ≤ the total ceiling, via one
 *   shared {@link ExtractionBudget}.
 *
...
/**
/** Extract the only non-manifest Lite payload. */
export function extractPayload(
  ...
  return extractEntryToFile(zip, shape.db, stagingDir, {
    absoluteCap: maxEntryBytes,
    budget,
