...
export const PORTABLE_DB_POLICIES: readonly TablePolicyEntry[] = Object.freeze([
  ...
  },
  {
    ...
    columns: [],
    evidence:
      'Lite carries the complete database but no filesystem payload. Knowledge-base rows are business data and are not rewritten here; Full transport and its index contract are deferred (src/main/features/knowledge/KnowledgeService.ts).'
  },
  {
    table: 'file_entry',
    policy: 'reset',
