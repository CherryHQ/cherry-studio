// ftsCentral — single owner of the FTS5 external-content rebuild + integrity-check
 ...
 */
export function rebuildFts(work: Database.Database): void {
 ...
 */
export function assertFtsIntegrity(work: Database.Database): void {
  for (const fts of Object.keys(DB_FTS_VIRTUAL_TABLES) as DbTableName[]) {
    try {
