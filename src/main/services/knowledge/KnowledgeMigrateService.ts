...
const logger = loggerService.withContext('KnowledgeMigrateService')
...
/**
 * KnowledgeMigrateService 负责将知识库从 embedjs libsql 迁移到 vectorstores libsql
 */
class KnowledgeMigrateService {
...
export const knowledgeMigrateService = new KnowledgeMigrateService()
