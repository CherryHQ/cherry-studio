...
describe('patched @ai-sdk/openai Responses reasoning parser', () => {
  it('preserves reasoning_text content from non-stream responses', async () => {
            ...
            output: [
              {
                ...
                content: [{ type: 'reasoning_text', text: 'The raw reasoning chain.' }],
                summary: []
              }
            ],
