...
export class ChannelMessageHandler {
  ...
  handleCommand(adapter: ChannelAdapter, command: ChannelCommandEvent): Promise<void> {
    return this.runWhenResumed(() => this.admitCommand(adapter, command))
  }

  private async admitCommand(adapter: ChannelAdapter, command: ChannelCommandEvent): Promise<void> {
