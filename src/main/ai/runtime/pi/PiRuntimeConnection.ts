...
export function buildPiLoginPathPrefix(loginPath: string | undefined): string | undefined {
  return loginPath ? `export PATH="$PATH":${quoteShellWord(loginPath)}` : undefined
}
