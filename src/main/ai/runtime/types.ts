...
export interface AgentRuntimeUserInput {
  ...
  /**
   * Exact greeting displayed before the first user message. Ephemeral model context only: runtimes
   * must not persist it as a session message or reuse it for later turns.
   */
