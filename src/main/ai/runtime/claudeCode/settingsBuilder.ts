...
import type { ClaudeCodeSettings, McpToolDisplayMetadata, SubagentImageSupport } from './types'
...
export interface ClaudeCodeSessionOptions {
  ...
  /** Per-alias image support from the effective route for subagent requests. */
