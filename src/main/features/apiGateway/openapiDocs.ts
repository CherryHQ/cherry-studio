...
export const DOC_DESCRIPTIONS = {
  ...
  manage_knowledge_bases: 'apiGateway.docs.operations.manage_knowledge_bases',
...
function docDescriptions(lang: LanguageVarious): Record<DocDescriptionSlot, string> {
  return {
    ...
    manage_knowledge_bases: t('apiGateway.docs.operations.manage_knowledge_bases', undefined, lang),
