...
const defaultApplicationGet = (name: Parameters<typeof application.get>[0]) =>
  application.getContainer().get(name) as ReturnType<typeof application.get>
  ...
  beforeEach(() => {
    ...
    dbh.db
      ...
      .values({
        ...
        baseId: BASE_ID,
        type: 'file',
        data: { source: '/source/doc.md', relativePath: 'doc.md' as PosixRelativeFilePath },
        status: 'completed'
      })
      .run()
  })
