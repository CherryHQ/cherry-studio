...
import type { AiToolResultResponse } from '@shared/ai/transport'
...
export const aiHandlers: IpcHandlersFor<typeof aiRequestSchemas> = {
  ...
  'ai.stream.open': async (request, { senderId }) => {
    ...
    return application.get('AiStreamManager').dispatch(subscriber, { ...request, interactionWindowId: senderId })
  },
