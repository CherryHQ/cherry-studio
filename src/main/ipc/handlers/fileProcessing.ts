 ...
 * shape at runtime but infers `path: string`, whereas `FileHandle.path` is the branded
 * `FilePath`. The cast bridges that brand gap (the repo convention — see FileManager.ts).
 */
