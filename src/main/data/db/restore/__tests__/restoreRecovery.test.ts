...
import { PROMOTION_STEP_ORDER_V2 } from '../restoreJournalV2'
import {
...
describe('phaseForStep', () => {
  it('derives pre-commit for every step before the DB commit and committed at/after it', () => {
    const commitIndex = PROMOTION_STEP_ORDER_V2.indexOf('db-promoted')
    PROMOTION_STEP_ORDER_V2.forEach((step, index) => {
...
// Full expected mapping mirrors docs/references/backup/README.md §6.4 plus the
// defensive completions of the 16-state total.
