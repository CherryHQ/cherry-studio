 ...
 *
 * Tags can be applied to topics, sessions, assistants, agents, skills, and models
 ...
 * various entity types (topic, session, assistant, agent, skill, model).
 */
export const entityTagTable = sqliteTable(
  'entity_tag',
  {
    // Entity type: topic, session, assistant, agent, skill, model
