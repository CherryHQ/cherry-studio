...
export const DB_COLUMNS_BY_TABLE = {
  ...
  knowledge_base: [
    ...
    { name: 'searchMode', dbName: 'searchMode', isPrimaryKey: false, isNullable: false, sqlType: 'text' },
    { name: 'hybridAlpha', dbName: 'hybridAlpha', isPrimaryKey: false, isNullable: true, sqlType: 'real' },
    { name: 'createdAt', dbName: 'createdAt', isPrimaryKey: false, isNullable: false, sqlType: 'integer' },
    { name: 'updatedAt', dbName: 'updatedAt', isPrimaryKey: false, isNullable: false, sqlType: 'integer' }
  ],
  knowledge_item: [
...
export const BACKUP_REFS_META = {
  generatedAt: '2026-07-02T05:36:48.510Z',
  schemaCommit: '6b44477c15'
} as const
