...
export const DB_COLUMNS_BY_TABLE = {
  ...
  agent_session: [
    ...
    { name: 'orderKey', dbName: 'orderKey', isPrimaryKey: false, isNullable: false, sqlType: 'text' },
    { name: 'lastActivityAt', dbName: 'lastActivityAt', isPrimaryKey: false, isNullable: false, sqlType: 'integer' },
    { name: 'createdAt', dbName: 'createdAt', isPrimaryKey: false, isNullable: false, sqlType: 'integer' },
    { name: 'updatedAt', dbName: 'updatedAt', isPrimaryKey: false, isNullable: false, sqlType: 'integer' }
  ],
  agent_session_message: [
    ...
    { name: 'delivery', dbName: 'delivery', isPrimaryKey: false, isNullable: true, sqlType: 'text' },
    { name: 'deliveryStatus', dbName: 'deliveryStatus', isPrimaryKey: false, isNullable: true, sqlType: 'text' },
    { name: 'deliveryTurnRef', dbName: 'deliveryTurnRef', isPrimaryKey: false, isNullable: true, sqlType: 'text' },
    { name: 'deliveryInReplyTo', dbName: 'deliveryInReplyTo', isPrimaryKey: false, isNullable: true, sqlType: 'text' },
    {
      name: 'deliverySenderSessionId',
      dbName: 'deliverySenderSessionId',
      isPrimaryKey: false,
      isNullable: true,
      sqlType: 'text'
    },
  ...
  agent_workspace: [
    ...
    { name: 'disconnectedPath', dbName: 'disconnectedPath', isPrimaryKey: false, isNullable: true, sqlType: 'text' },
    { name: 'type', dbName: 'type', isPrimaryKey: false, isNullable: false, sqlType: 'text' },
    { name: 'orderKey', dbName: 'orderKey', isPrimaryKey: false, isNullable: false, sqlType: 'text' },
    { name: 'createdAt', dbName: 'createdAt', isPrimaryKey: false, isNullable: false, sqlType: 'integer' },
    { name: 'updatedAt', dbName: 'updatedAt', isPrimaryKey: false, isNullable: false, sqlType: 'integer' }
  ...
  translate_history: [
    { name: 'id', dbName: 'id', isPrimaryKey: true, isNullable: false, sqlType: 'text' },
    { name: 'kind', dbName: 'kind', isPrimaryKey: false, isNullable: false, sqlType: 'text' },
...
export const DB_PRIMARY_KEYS = {
  ...
  translate_history_file_ref: {
    table: 'translate_history_file_ref',
    columns: ['id'],
    kind: 'uuid-v4',
    ambiguous: false
  },
...
export const DB_FOREIGN_KEYS = {
  ...
  translate_history_file_ref: [
    { columns: ['fileEntryId'], targetTable: 'file_entry', targetColumns: ['id'], onDelete: 'cascade' },
    { columns: ['sourceId'], targetTable: 'translate_history', targetColumns: ['id'], onDelete: 'cascade' }
  ],
  translate_language: [],
  user_model: [
...
export const DB_UNIQUE_KEYS = {
  ...
  agent_session_message: [{ columns: ['deliveryInReplyTo'] }, { columns: ['ftsRowid'] }],
  ...
  topic: [],
  translate_history: [],
  translate_history_file_ref: [{ columns: ['sourceId', 'role'] }],
  translate_language: [],
...
export const DB_JSON_COLUMNS = {
  ...
  agent_mcp_server: [],
  agent_session: [],
  agent_session_message: ['data', 'messageSnapshot', 'stats', 'delivery'],
  agent_session_message_file_ref: [],
  agent_skill: [],
  agent_workspace: [],
  ...
  message: ['data', 'messageSnapshot', 'stats'],
...
export const BACKUP_REFS_META = {
  generatedAt: '2026-08-29T17:08:39.735Z'
} as const
