...
/** @deprecated Removed with the four-entry bundle in the next migration diagnostics checkpoint. */
...
/** @deprecated Compatibility schema for the old bundle module until it is replaced. */
...
/** @deprecated Compatibility schemas for the old bundle module until it is replaced. */
export const migrationDatabaseL0DataSchema = z.unknown()
export const migrationDatabaseL1DataSchema = z.unknown()
export const migrationDatabaseL2DataSchema = z.unknown()
export const migrationDatabaseDiagnosticStepSchema = z.unknown()
export const migrationDatabaseL0StepSchema = z.unknown()
export const migrationDatabaseL1StepSchema = z.unknown()
export const migrationDatabaseL2StepSchema = z.unknown()
export type MigrationDatabaseColumnCountBucket = never
export type MigrationDatabaseCompletedDiagnosticResult = never
export type MigrationDatabaseCompletionFailureCode = z.infer<typeof migrationDatabaseCompletionFailureCodeSchema>
export type MigrationDatabaseCountBucket = never
export type MigrationDatabaseDiagnosticStep = never
export type MigrationDatabaseExpectedObjectDefinition = never
export type MigrationDatabaseExpectedObjectId = never
export type MigrationDatabaseFailedDiagnosticResult = never
export type MigrationDatabaseFailureCode = z.infer<typeof migrationDatabaseFailureCodeSchema>
export type MigrationDatabaseIntegerBucket = never
export type MigrationDatabaseL0Data = unknown
export type MigrationDatabaseL0Step = unknown
export type MigrationDatabaseL1Data = unknown
export type MigrationDatabaseL1Step = unknown
export type MigrationDatabaseL2Data = unknown
export type MigrationDatabaseL2Step = unknown
export type MigrationDatabaseObjectKind = never
export type MigrationDatabaseTimedOutDiagnosticResult = never
export type MigrationDatabaseUnknownObjectKind = never
