...
import { type DataApiWriteRunner, IpcAdapter } from '../IpcAdapter'
...
describe('IpcAdapter', () => {
  ...
  beforeEach(() => {
    ...
    new IpcAdapter({ handleRequest } as unknown as ApiServer, runWrite as unknown as DataApiWriteRunner).setup()
