...
export const tabRequestSchemas = {
  ...
  'tab.detach': defineRoute({
    // Mirrors SubWindowService.createWindow's tab identity, URL, presentation, generic
    // per-tab metadata, and optional drag-drop position; extra Tab fields are stripped.
    input: z.object({
      id: z.string(),
      url: z.string(),
