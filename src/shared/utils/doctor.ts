...
/**
 * Pure projection of a report onto a view. Shared views rebuild each result from an
 * allowlist so actions, developer text and raw errors cannot cross the process boundary.
 */
