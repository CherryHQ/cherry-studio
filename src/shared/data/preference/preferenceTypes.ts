...
/** Chat resource-list layout: 'traditional' = entity rail + right resource panel, 'efficiency' = classic single sidebar. */
export type ChatViewMode = 'efficiency' | 'traditional'
