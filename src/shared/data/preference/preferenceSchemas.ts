 ...
 * Generated at: 2026-09-23T18:50:42.977Z
 *
...
export const DefaultPreferences: PreferenceSchemas = {
  default: {
    ...
    'shortcut.tab.history.back': { binding: ['Alt', 'Left'], enabled: true },
    'shortcut.tab.history.forward': { binding: ['Alt', 'Right'], enabled: true },
