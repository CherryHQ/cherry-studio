 ...
 * Generated at: 2026-09-26T03:52:16.215Z
 *
...
export interface PreferenceSchemas {
  default: {
    ...
    // target-key-definitions/complex/complex
    'shortcut.tab.history.back': PreferenceTypes.PreferenceShortcutType
    // target-key-definitions/complex/complex
    'shortcut.tab.history.forward': PreferenceTypes.PreferenceShortcutType
    // target-key-definitions/complex/complex
...
export const DefaultPreferences: PreferenceSchemas = {
  default: {
    ...
    'shortcut.app.sidebar.toggle': { binding: ['CommandOrControl', '['], customized: false, enabled: true },
    ...
    'shortcut.tab.history.back': { binding: ['CommandOrControl', '['], enabled: true },
    'shortcut.tab.history.forward': { binding: ['CommandOrControl', ']'], enabled: true },
    ...
    'shortcut.topic.sidebar.toggle': { binding: ['CommandOrControl', ']'], customized: false, enabled: true },
