 ...
 * Generated at: 2026-09-01T07:22:53.980Z
 *
...
export interface PreferenceSchemas {
  default: {
    ...
    // target-key-definitions/complex/complex
    'ui.sidebar.favorites': PreferenceTypes.SidebarShortcutItem[]
...
export const DefaultPreferences: PreferenceSchemas = {
  default: {
    ...
    'ui.sidebar.favorites': [
      {
        id: 'sidebar-shortcut:core.app:assistants',
        target: { kind: 'resource', locator: { providerId: 'core.app', resourceId: 'assistants' } },
        type: 'shortcut'
      },
      {
        id: 'sidebar-shortcut:core.app:agents',
        target: { kind: 'resource', locator: { providerId: 'core.app', resourceId: 'agents' } },
        type: 'shortcut'
      },
      {
        id: 'sidebar-shortcut:core.app:translate',
        target: { kind: 'resource', locator: { providerId: 'core.app', resourceId: 'translate' } },
        type: 'shortcut'
      },
      {
        id: 'sidebar-shortcut:core.app:paintings',
        target: { kind: 'resource', locator: { providerId: 'core.app', resourceId: 'paintings' } },
        type: 'shortcut'
      },
      {
        id: 'sidebar-shortcut:core.app:knowledge',
        target: { kind: 'resource', locator: { providerId: 'core.app', resourceId: 'knowledge' } },
        type: 'shortcut'
      }
    ],
