...
- `pnpm build:check` — **REQUIRED before commits**. On formatting failures, run `pnpm format`; on broken doc links, fix the link.
...
- Do not run `pnpm i18n:sync` or edit `src/{main,renderer}/i18n/translate/`; GitHub Workflow owns generated translations
