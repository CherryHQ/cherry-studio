...
const ASYNC_IMPORT_BANS = [
  ...
  },
  {
    ...
    message: 'Import asynchronous primitives through @shared/utils/async to preserve cancellation and cleanup contracts.'
  }
]
...
export default defineConfig([
  ...
  },
  {
    ...
    rules: {
      '@typescript-eslint/no-restricted-imports': ['error', { patterns: [BAN_RENDERER_FROM_MAIN, BAN_DRIZZLE_MIGRATOR, ...ASYNC_IMPORT_BANS] }]
    }
  },
  {
