...
| [Image Workflow](./references/ai/image-workflow.md) | Image model configuration, standard API routing, versioned paintings, durable task recovery, and generated-file delivery |
