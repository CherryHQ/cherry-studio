...
| [Local Models](./references/ai/local-models.md) | Local model subsystem — the bundle catalog, on-disk registry, and the verified acquisition layer that installs models and shared native runtimes |
