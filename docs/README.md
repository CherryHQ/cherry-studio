...
| [The Boss integration release](./contrib/the-boss-release.md) | Native integration payloads, installer publication, and installed Windows acceptance for The Boss |
