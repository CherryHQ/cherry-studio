...
| [Local Models](./references/ai/local-models.md) | Local model subsystem — the bundle catalog, on-disk registry, the verified acquisition layer, and the worker runtime that infers over the installed models |
