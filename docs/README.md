...
| [Diagnostic Chat Record Metadata Selection](./contrib/diagnostic-chat-record-metadata-selection.md) | Metadata-first selection design for memory-bounded diagnostic chat record export |
