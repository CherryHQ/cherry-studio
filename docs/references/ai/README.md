...
| [AI Usage Records](./ai-usage-records.md) | Best-effort per-request usage/cost analytics: request capture, attribution snapshots, bounded query API, migration projection, freshness |
