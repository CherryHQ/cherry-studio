...
└── tree/                    ← second top-level primitive, parallel to FileManager
      ...
      │                        owns the file.tree.* IpcApi contract; dedupes
