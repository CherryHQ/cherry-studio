...
> **Note:** This file is auto-generated. Add or change keys in `v2-refactor-temp/tools/data-classify/data/classification.json`, `target-key-definitions.json`, or the generator's documented manual-item list, then run the data-classify generator. Never edit `bootConfigSchemas.ts` by hand.
