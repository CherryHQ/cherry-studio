...
- Restoring an assistant or agent restores only that owner. Related topics or sessions remain in the Recycle Bin and must be restored separately. The immediate Undo action restores the exact conversations moved by that delete operation.
