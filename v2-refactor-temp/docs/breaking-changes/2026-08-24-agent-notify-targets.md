...
Start the Agent from a channel, or configure destination channels for the scheduled task. Use an explicit configured channel ID only when selecting one allowed recipient.
