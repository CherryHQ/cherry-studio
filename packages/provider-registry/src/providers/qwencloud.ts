...
/** DeepSeek-V4 / GLM hosted lines take a `high`/`max` effort on Chat Completions. */
const highMaxModels = ['deepseek-v4-pro', 'deepseek-v4-flash', 'glm-5', 'glm-5.1', 'glm-5.2']
 ...
 * search through the Responses API instead; omni lines ride the multimodal API, not Chat).
 * Prefixes hit canonical ids, so dated snapshots and `-preview` fold into their line.
 */
