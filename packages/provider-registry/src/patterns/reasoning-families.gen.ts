...
export const REASONING_FAMILY_RULES: readonly ReasoningFamilyRule[] = [
  ...
  {"pattern":"^(?!.*(?:coder|asr|tts|reranker|embedding|instruct|thinking))(?:qwen3-max(?!-2025-09-23)|qwen-max-latest)(?:-|$)"},
  {"pattern":"^(?!.*(?:coder|asr|tts|reranker|embedding|instruct|thinking))qwen(?:3[.-][5-9])?-(?:plus|flash|turbo)(?:-|$)"},
  {"pattern":"^(?!.*(?:coder|asr|tts|reranker|embedding|instruct|thinking))qwen-?3-\\d"},
  {"pattern":"^(?!.*(?:coder|instruct))qwen-?3-(?:vl|omni|next)"},
  // amazon
  {"pattern":"^nova-2"},
  // anthropic
  {"pattern":"^(?:anthropic\\.)?claude-fable","effort":["low","medium","high","max"],"toggle":false,"wireDialect":"effort"},
  {"pattern":"^(?:anthropic\\.)?claude-(?:(?:opus|sonnet|haiku)-(?:4[.-][6-9]|[5-9])(?!\\d)|(?:opus|sonnet|haiku)-latest)","effort":["low","medium","high","max"],"toggle":true,"wireDialect":"effort"},
  {"pattern":"^(?:anthropic\\.)?claude","toggle":true,"wireDialect":"budget","template":true},
  {"pattern":"(?:anthropic\\.)?claude-opus-4[.-]7(?:[@\\-:][\\w\\-:]+)?$","budget":{"min":1024,"max":128000},"template":true},
  {"pattern":"(?:anthropic\\.)?claude-opus-4[.-]6(?:[@\\-:][\\w\\-:]+)?$","budget":{"min":1024,"max":128000},"template":true},
  {"pattern":"(?:anthropic\\.)?claude-(:?sonnet|haiku)-4[.-]6.*(?:-v\\d+:\\d+)?$","budget":{"min":1024,"max":64000},"template":true},
  {"pattern":"(?:anthropic\\.)?claude-(:?haiku|sonnet|opus)-4[.-]5.*(?:-v\\d+:\\d+)?$","budget":{"min":1024,"max":64000},"template":true},
  {"pattern":"(?:anthropic\\.)?claude-opus-4[.-]1.*(?:-v\\d+:\\d+)?$","budget":{"min":1024,"max":32000},"template":true},
  {"pattern":"(?:anthropic\\.)?claude-sonnet-4(?:[.-]0)?(?:[@-](?:\\d{4,}|[a-z][\\w-]*))?(?:-v\\d+:\\d+)?$","budget":{"min":1024,"max":64000},"template":true},
  {"pattern":"(?:anthropic\\.)?claude-opus-4(?:[.-]0)?(?:[@-](?:\\d{4,}|[a-z][\\w-]*))?(?:-v\\d+:\\d+)?$","budget":{"min":1024,"max":32000},"template":true},
  {"pattern":"(?:anthropic\\.)?claude-3[.-]7.*sonnet.*(?:-v\\d+:\\d+)?$","budget":{"min":1024,"max":64000},"template":true},
  ...
  {"pattern":"^inkling"},
  // bytedance
  {"pattern":"doubao-seed-1-6-(?:lite-)?251015|doubao-seed-2[.-]\\d|doubao-seed-1[.-]8","effort":["minimal","low","medium","high"]},
  {"pattern":"doubao-(1-5-thinking-pro-m|seed-1[.-]6)(?!-(?:flash|thinking)(?:-|$))(?:-lite)?(?!-251015)(?:-\\d+)?$","effort":["none","auto","high"]},
  {"pattern":"doubao-(?:1[.-]5-thinking-vision-pro|1[.-]5-thinking-pro-m|seed-1[.-][68](?:-flash)?(?!-thinking(?:-|$))|seed-code(?:-preview)?(?:-\\d+)?|seed-2[.-]\\d(?:-[\\w-]+)?)(?:-[\\w-]+)*","effort":["none","high"],"budget":{"min":0,"max":30720}},
  {"pattern":"doubao-(?:1[.-]5-thinking-vision-pro|1[.-]5-thinking-pro-m|seed-1[.-][68](?:-flash)?(?!-thinking(?:-|$))|seed-code(?:-preview)?(?:-\\d+)?|seed-2[.-]\\d(?:-[\\w-]+)?)(?:-[\\w-]+)*"},
  {"pattern":"seed-oss"},
  {"pattern":"^seed-[12][.-]\\d"},
  // cohere
  ...
  {"pattern":"^gemini-3(?:\\.\\d+)?-flash|^gemini-3\\.1-flash-lite|^gemini-flash-latest","effort":["minimal","low","medium","high"]},
  ...
  {"pattern":"^(?!.*tts).*gemini-(?:2[.-]5.*(?:-latest)?|3(?:[.-]\\d+)?-(?:flash|pro)(?:-preview)?|flash-latest|pro-latest|flash-lite-latest)(?:-[\\w-]+)*$"},
