...
const sliderThumbVariants = cva(
  cn(
    'block shrink-0 rounded-full border border-control-accent/40 bg-white shadow-sm transition-[color,box-shadow]',
    'ring-inset ring-control-accent/30 hover:ring-2 focus-visible:ring-2 focus-visible:outline-hidden',
