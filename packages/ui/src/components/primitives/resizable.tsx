  ...
  return (
    <ResizablePrimitive.Separator
      ...
      className={cn(
        ...
        'after:absolute after:inset-yb-0 after:start-1/2 after:w-3 after:-translate-x-1/2',
        ...
        'aria-[orientation=horizontal]:after:inset-xi-0 aria-[orientation=horizontal]:after:top-1/2',
