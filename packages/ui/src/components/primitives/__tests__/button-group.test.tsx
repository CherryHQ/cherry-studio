...
describe('ButtonGroup', () => {
  it('overlaps attached horizontal button seams', () => {
    ...
    expect(screen.getByRole('group')).toHaveClass('[&>[data-ui~="part:button"][data-variant=default]]:relative')
    expect(screen.getByRole('group')).toHaveClass('[&>[data-ui~="part:button"][data-variant=default]]:z-1')
  })
