...
describe('Tooltip', () => {
  ...
  describe('controlled mode', () => {
    ...
    it('uses the primary surface pair in both color modes', () => {
      render(
      ...
      expect(content).not.toHaveClass('dark:bg-neutral-100', 'dark:text-neutral-900')
    })
  ...
  describe('arrow rendering', () => {
    it('renders a positioned Radix arrow by default for TooltipContent', () => {
      ...
      expect(arrow).toHaveClass('fill-primary', 'stroke-primary', 'stroke-2')
