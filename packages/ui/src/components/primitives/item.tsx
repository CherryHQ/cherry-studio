...
const itemVariants = cva(
  'group/item flex flex-wrap items-center rounded-md border border-transparent text-sm transition-colors duration-100 outline-none focus-visible:border-ring [a]:transition-colors [a]:hover:bg-accent/50 [a]:focus-visible:bg-accent/50',
  {
    variants: {
      variant: {
