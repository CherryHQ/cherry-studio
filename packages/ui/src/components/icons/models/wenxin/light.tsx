...
const WenxinLight: IconComponent = (props: SVGProps<SVGSVGElement>) => {
  const iconId = useId()
  ...
  return (
    <svg
      ...
      />
      <defs>
        <linearGradient id={`${iconId}-wenxinlight__a`} x1="9.155%" x2="90.531%" y1="75.177%" y2="25.028%">
