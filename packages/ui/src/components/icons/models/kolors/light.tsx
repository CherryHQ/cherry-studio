...
const KolorsLight: IconComponent = (props: SVGProps<SVGSVGElement>) => {
  const iconId = useId()
  ...
  return (
    <svg
      ...
      {...props}>
      <path
        fill={`url(#${iconId}-kolorslight__a)`}
        fillRule="evenodd"
      ...
      <defs>
        <radialGradient
          id={`${iconId}-kolorslight__a`}
          cx={0}
          cy={0}
          r={1}
          gradientTransform="matrix(-10.99996 10.50004 -15.35334 -16.08433 12 12)"
          gradientUnits="userSpaceOnUse">
          <stop offset={0.413} stopColor="#CBFF00" />
          <stop offset={0.678} stopColor="#7EF426" />
        </radialGradient>
      </defs>
    </svg>
  )
