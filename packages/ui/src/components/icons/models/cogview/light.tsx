...
const CogviewLight: IconComponent = (props: SVGProps<SVGSVGElement>) => {
  ...
  return (
    <svg
      ...
      viewBox="0.937 0 22.126 24"
      {...props}>
      <path
        fill={`url(#${iconId}-cogviewlight__a)`}
        d="M15.271 16.555l5.72 4.877s-3.276 3.125-7.223-2.866l1.503-2.01z"
      />
      <path fill={`url(#${iconId}-cogviewlight__b)`} d="M15.4 16.523l4.596 5.947s-3.85 2.39-6.477-4.293l1.882-1.654z" />
      <path
      ...
      />
      <path fill={`url(#${iconId}-cogviewlight__z)`} d="M13.52 5.504a.724.724 0 100-1.449.724.724 0 000 1.449z" />
      <path
        fill={`url(#${iconId}-cogviewlight__A)`}
        d="M13.357 5.169c.257 0 .465-.223.465-.498 0-.274-.208-.497-.465-.497s-.465.223-.465.497c0 .275.208.498.465.498z"
      />
      <path fill="#fff" d="M13.681 4.423a.108.108 0 100-.217.108.108 0 000 .217z" />
      <defs>
        <linearGradient
        ...
        <radialGradient
          ...
          cy={0}
          r={1}
          gradientTransform="translate(13.173 4.8)scale(.9051)"
          gradientUnits="userSpaceOnUse">
        ...
        <radialGradient
          ...
          cy={0}
          r={1}
          gradientTransform="translate(13.13 4.64)scale(.97336)"
          gradientUnits="userSpaceOnUse">
          <stop />
