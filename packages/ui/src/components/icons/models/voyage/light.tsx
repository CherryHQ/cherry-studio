...
const VoyageLight: IconComponent = (props: SVGProps<SVGSVGElement>) => {
  const iconId = useId()

  return (
    <svg xmlns="http://www.w3.org/2000/svg" width="1em" height="1em" fill="none" viewBox="0 0 12 12" {...props}>
      <g clipPath={`url(#${iconId}-voyagelight__a)`}>
        <path
          fill="#000"
      ...
      <defs>
        <clipPath id={`${iconId}-voyagelight__a`}>
