...
const GeminiDark: IconComponent = (props: SVGProps<SVGSVGElement>) => (
  <svg xmlns="http://www.w3.org/2000/svg" width="1em" height="1em" fill="none" viewBox="0 0 24 24" {...props}>
    <g clipPath="url(#geminidark__a)">
      <path
        fill="url(#geminidark__b)"
    ...
    <defs>
      <linearGradient id="geminidark__b" x1={-9} x2={19.439} y1={29.5} y2={1.438} gradientUnits="userSpaceOnUse">
        <stop offset={0.193} stopColor="#1C7DFF" />
        <stop offset={0.52} stopColor="#1C69FF" />
        <stop offset={1} stopColor="#F0DCD6" />
      </linearGradient>
      <clipPath id="geminidark__a">
