...
const Ai360Light: IconComponent = (props: SVGProps<SVGSVGElement>) => {
  ...
  return (
    <svg
      ...
      />
      <path fill={`url(#${iconId}-ai360light__d)`} d="M13.83 7.961a.755.755 0 11-1.51 0 .755.755 0 011.51 0z" />
      <path fill={`url(#${iconId}-ai360light__e)`} d="M10.809 16.678a.755.755 0 100-1.511.755.755 0 000 1.51z" />
      <defs>
        <linearGradient id={`${iconId}-ai360light__a`} x1={12} x2={12} y1={0} y2={24} gradientUnits="userSpaceOnUse">
          <stop stopColor="#12B7FA" />
          <stop offset={1} stopColor="#006ffb" />
        </linearGradient>
        <linearGradient
          id={`${iconId}-ai360light__b`}
          x1={11.943}
          x2={11.943}
          y1={6.085}
          y2={17.778}
