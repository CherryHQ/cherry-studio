...
const PoolsideLight: IconComponent = (props: SVGProps<SVGSVGElement>) => {
  ...
  return (
    <svg
      ...
      viewBox="0 0 24 24"
      {...props}>
      <g clipPath={`url(#${iconId}-poolsidelight__lobe-icons-poolside-0-_R_0_)`}>
        <mask
          ...
          <path fill={`url(#${iconId}-poolsidelight__a)`} d="M24 0H0v24h24V0z" />
          <path fill={`url(#${iconId}-poolsidelight__b)`} d="M24 0H0v24h24V0z" />
          <path fill={`url(#${iconId}-poolsidelight__c)`} d="M24 0H0v24h24V0z" />
        </mask>
