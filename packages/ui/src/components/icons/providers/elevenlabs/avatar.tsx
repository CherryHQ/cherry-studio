  ...
  return (
    <Avatar
      ...
      <AvatarFallback className="text-foreground bg-background">
        <ElevenlabsLight className="dark:hidden" style={{ width: size * 0.7, height: size * 0.7 }} />
        <ElevenlabsDark className="hidden dark:block" style={{ width: size * 0.7, height: size * 0.7 }} />
      </AvatarFallback>
    </Avatar>
  )
}
