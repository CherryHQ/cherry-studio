...
const KlingDark: IconComponent = (props: SVGProps<SVGSVGElement>) => (
  <svg xmlns="http://www.w3.org/2000/svg" width="1em" height="1em" fill="none" viewBox="0 0 120 120" {...props}>
    <g clipPath="url(#klingdark__a)">
      <path
        fill="url(#klingdark__b)"
    ...
    <defs>
      ...
      <linearGradient id="klingdark__d" x1={72.82} x2={81.721} y1={23.443} y2={52.335} gradientUnits="userSpaceOnUse">
        <stop stopColor="#003EFF" />
        <stop offset={1} stopColor="#0BFFE7" />
      </linearGradient>
      <linearGradient id="klingdark__e" x1={47.18} x2={38.279} y1={96.342} y2={67.45} gradientUnits="userSpaceOnUse">
        <stop stopColor="#003EFF" />
        <stop offset={1} stopColor="#0BFFE7" />
      </linearGradient>
      <clipPath id="klingdark__a">
