...
const AzureaiDark: IconComponent = (props: SVGProps<SVGSVGElement>) => (
  <svg xmlns="http://www.w3.org/2000/svg" width="1em" height="1em" fill="none" viewBox="0 0 120 120" {...props}>
    <g clipPath="url(#azureaidark__a)">
      <mask
        id="azureaidark__b"
        width={86}
        height={86}
      ...
      <g mask="url(#azureaidark__b)">
        <path
          fill="url(#azureaidark__c)"
          fillRule="evenodd"
