  ...
  return (
    <Avatar
      ...
      <AvatarFallback className="text-foreground bg-background">
        <InceptionlabsLight className="dark:hidden" style={{ width: size * 0.7, height: size * 0.7 }} />
        <InceptionlabsDark className="hidden dark:block" style={{ width: size * 0.7, height: size * 0.7 }} />
      </AvatarFallback>
    </Avatar>
  )
}
