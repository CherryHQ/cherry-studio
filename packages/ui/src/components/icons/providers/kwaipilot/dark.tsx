...
const KwaipilotDark: IconComponent = (props: SVGProps<SVGSVGElement>) => (
  <svg xmlns="http://www.w3.org/2000/svg" width="1em" height="1em" fill="none" viewBox="0 0 120 120" {...props}>
    <path
      fill="url(#kwaipilotdark__a)"
...
export { KwaipilotDark }
export default KwaipilotDark
