...
const GoogleDark: IconComponent = (props: SVGProps<SVGSVGElement>) => (
  <svg xmlns="http://www.w3.org/2000/svg" width="1em" height="1em" fill="none" viewBox="0 0 120 120" {...props}>
    <g clipPath="url(#googledark__a)">
      <mask
        id="googledark__b"
        width={86}
        height={86}
      ...
      <g mask="url(#googledark__b)">
        <g filter="url(#googledark__c)">
          <path
            fill="url(#googledark__d)"
        ...
        <g filter="url(#googledark__e)">
          <path
            fill="url(#googledark__f)"
        ...
        <g filter="url(#googledark__g)">
          <path
            fill="url(#googledark__h)"
        ...
        <g filter="url(#googledark__i)">
          <path
            fill="url(#googledark__j)"
        ...
        <g filter="url(#googledark__l)">
          <path
            fill="url(#googledark__m)"
        ...
        <g filter="url(#googledark__n)">
          <path
            fill="url(#googledark__o)"
        ...
        <g filter="url(#googledark__p)">
          <path
            fill="url(#googledark__q)"
        ...
        <g filter="url(#googledark__r)" opacity={0.5}>
          <path
            fill="url(#googledark__s)"
    ...
    <defs>
      <filter
        ...
        <feGaussianBlur result="effect1_foregroundBlur_37_1611" stdDeviation={0.074} />
      </filter>
      <filter
        id="googledark__e"
        width={30.592}
      ...
      <filter
        ...
        <feFlood floodOpacity={0} result="BackgroundImageFix" />
        <feBlend in="SourceGraphic" in2="BackgroundImageFix" result="shape" />
        <feGaussianBlur result="effect1_foregroundBlur_37_1611" stdDeviation={0.519} />
      </filter>
      <filter
        id="googledark__p"
        width={31.29}
      ...
      <linearGradient id="googledark__s" x1={55.67} x2={66.127} y1={94.188} y2={94.188} gradientUnits="userSpaceOnUse">
        <stop stopColor="#0FBC5C" />
        <stop offset={1} stopColor="#0CBA65" />
      </linearGradient>
      <clipPath id="googledark__a">
