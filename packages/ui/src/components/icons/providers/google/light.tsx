...
const GoogleLight: IconComponent = (props: SVGProps<SVGSVGElement>) => (
  <svg xmlns="http://www.w3.org/2000/svg" width="1em" height="1em" fill="none" viewBox="0 0 120 120" {...props}>
    <g clipPath="url(#googlelight__a)">
      ...
      <g mask="url(#googlelight__b)">
        <g filter="url(#googlelight__c)">
          <path
            fill="url(#googlelight__d)"
        ...
        <g filter="url(#googlelight__e)">
          <path
            fill="url(#googlelight__f)"
        ...
        <g filter="url(#googlelight__g)">
          <path
            fill="url(#googlelight__h)"
        ...
        <g filter="url(#googlelight__i)">
          <path
            fill="url(#googlelight__j)"
        ...
        <g filter="url(#googlelight__l)">
          <path
            fill="url(#googlelight__m)"
        ...
        <g filter="url(#googlelight__n)">
          <path
            fill="url(#googlelight__o)"
        ...
        <g filter="url(#googlelight__p)">
          <path
            fill="url(#googlelight__q)"
        ...
        <g filter="url(#googlelight__r)" opacity={0.5}>
          <path
            fill="url(#googlelight__s)"
    ...
    <defs>
      ...
      <linearGradient id="googlelight__s" x1={55.67} x2={66.127} y1={94.188} y2={94.188} gradientUnits="userSpaceOnUse">
        <stop stopColor="#0FBC5C" />
        <stop offset={1} stopColor="#0CBA65" />
      </linearGradient>
      <clipPath id="googlelight__a">
