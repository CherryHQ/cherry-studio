        ...
        <DialogContent size="sm">
          ...
          <div className="flex flex-col gap-1.5">
            ...
            <input
              ...
              className="h-9 rounded-md border px-3 text-sm focus:border-ring focus:outline-none"
            />
          </div>
          <DialogFooter>
            <DialogClose asChild>
        ...
        <div className="grid gap-4 py-4">
          <div className="grid grid-cols-4 items-center gap-4">
            ...
            <input
              ...
              className="col-span-3 h-9 rounded-md border px-3 text-sm focus:border-ring focus:outline-none"
            />
          </div>
          <div className="grid grid-cols-4 items-center gap-4">
