...
describe('buildThemeContractCss', () => {
  it('maps token sources into the public theme contract', async () => {
    ...
    expect(css).toContain('--cs-theme-control-accent: var(--cs-primary);')
    expect(css).not.toContain('--cs-theme-control-accent-hover')
    ...
    expect(css).toContain('--color-link: var(--color-control-accent);')
