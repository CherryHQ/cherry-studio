...
/**
 * @generated from message catalog.v1.EndpointConfig
 */
export type EndpointConfig = Message<'catalog.v1.EndpointConfig'> & {
  /**
   ...
   *
   * @generated from field: optional catalog.v1.ModelsApiUrls models_api_urls = 2;
   */
   ...
   *
   * @generated from field: optional catalog.v1.ProviderReasoningFormat reasoning_format = 3;
   */
  reasoningFormat?: ProviderReasoningFormat
}

/**
 * Describes the message catalog.v1.EndpointConfig.
...
export type ProviderConfig = Message<'catalog.v1.ProviderConfig'> & {
   ...
   *
   * @generated from field: map<int32, catalog.v1.EndpointConfig> endpoint_configs = 10;
   */
 ...
 */
export const ProviderCatalogSchema: GenMessage<ProviderCatalog> = /*@__PURE__*/ messageDesc(file_v1_provider, 17)
