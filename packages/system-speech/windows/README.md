...
stdin/stdout JSON envelope for `capabilities`, `list_asr_locales`, `transcribe`,
and `synthesize`. It enumerates installed SAPI 5 recognizer and voice tokens,
