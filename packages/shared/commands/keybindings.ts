...
import { normalizeShortcutBinding, type ShortcutBinding, type ShortcutToken } from '@shared/shortcuts/tokens'
import { convertKeyToAccelerator, formatShortcutDisplay } from '@shared/shortcuts/utils'
