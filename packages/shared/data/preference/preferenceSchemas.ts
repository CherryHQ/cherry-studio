 ...
 * Generated at: 2026-04-17T13:24:59.257Z
 *
...
export interface PreferenceSchemas {
  default: {
    ...
    // redux/memory/autoRetainBatchSize
    'feature.memory.auto_retain_batch_size': number
    // redux/memory/autoRetainDebounceMs
    'feature.memory.auto_retain_debounce_ms': number
    // redux/memory/memoryBankStrategy
    'feature.memory.bank_strategy': string
    ...
    // redux/memory/hindsightApiKey
    'feature.memory.hindsight.api_key': string
    // redux/memory/hindsightBaseUrl
    'feature.memory.hindsight.base_url': string
    // redux/memory/hindsightDefaultBankPrefix
    'feature.memory.hindsight.default_bank_prefix': string
    // redux/memory/hindsightReflectEnabled
    'feature.memory.hindsight.reflect_enabled': boolean
    // redux/memory/hindsightTimeoutMs
    'feature.memory.hindsight.timeout_ms': number
    // redux/memory/libsqlAutoDimensions
    'feature.memory.libsql.auto_dimensions': boolean
    // redux/memory/libsqlEmbedderDimensions
    'feature.memory.libsql.embedder_dimensions': number
    // redux/memory/libsqlEmbedderModel
    'feature.memory.libsql.embedder_model': string
    // redux/memory/customFactExtractionPrompt
    'feature.memory.libsql.fact_extraction_prompt': string
    // redux/memory/libsqlSimilarityThreshold
    'feature.memory.libsql.similarity_threshold': number
    // redux/memory/customUpdateMemoryPrompt
    'feature.memory.libsql.update_memory_prompt': string
    // redux/memory/memoryProvider
    'feature.memory.provider': string
...
export const DefaultPreferences: PreferenceSchemas = {
  default: {
    ...
    'feature.memory.auto_retain_batch_size': 8,
    'feature.memory.auto_retain_debounce_ms': 1500,
    ...
    'feature.memory.hindsight.timeout_ms': 10000,
    'feature.memory.libsql.auto_dimensions': true,
    'feature.memory.libsql.embedder_dimensions': 1536,
    'feature.memory.libsql.embedder_model': '',
    'feature.memory.libsql.fact_extraction_prompt': '',
    'feature.memory.libsql.similarity_threshold': 0.85,
    'feature.memory.libsql.update_memory_prompt': '',
