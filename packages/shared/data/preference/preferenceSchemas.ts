 ...
 * Generated at: 2026-04-07T12:06:27.869Z
 *
...
export interface PreferenceSchemas {
  default: {
    ...
    'shortcut.app.chat.clear': PreferenceTypes.PreferenceShortcutType
    ...
    'shortcut.app.chat.search_message': PreferenceTypes.PreferenceShortcutType
    // redux/shortcuts/shortcuts.select_model
    'shortcut.app.chat.select_model': PreferenceTypes.PreferenceShortcutType
    // redux/shortcuts/shortcuts.toggle_new_context
    'shortcut.app.chat.toggle_new_context': PreferenceTypes.PreferenceShortcutType
    ...
    'shortcut.app.general.show_mini_window': PreferenceTypes.PreferenceShortcutType
    ...
    'shortcut.app.general.toggle_show_assistants': PreferenceTypes.PreferenceShortcutType
...
export const DefaultPreferences: PreferenceSchemas = {
  default: {
    ...
    'shortcut.app.chat.edit_last_user_message': { enabled: false, key: ['CommandOrControl', 'Shift', 'E'] },
    'shortcut.app.chat.search_message': { enabled: true, key: ['CommandOrControl', 'F'] },
    'shortcut.app.chat.select_model': { enabled: true, key: ['CommandOrControl', 'Shift', 'M'] },
    'shortcut.app.chat.toggle_new_context': { enabled: true, key: ['CommandOrControl', 'K'] },
    'shortcut.app.general.exit_fullscreen': { enabled: true, key: ['Escape'] },
    'shortcut.app.general.search': { enabled: true, key: ['CommandOrControl', 'Shift', 'F'] },
    'shortcut.app.general.show_main_window': { enabled: true, key: [] },
    'shortcut.app.general.show_mini_window': { enabled: false, key: ['CommandOrControl', 'E'] },
    'shortcut.app.general.show_settings': { enabled: true, key: ['CommandOrControl', ','] },
    'shortcut.app.general.toggle_show_assistants': { enabled: true, key: ['CommandOrControl', '['] },
    'shortcut.app.general.zoom_in': { enabled: true, key: ['CommandOrControl', '='] },
    'shortcut.app.general.zoom_out': { enabled: true, key: ['CommandOrControl', '-'] },
    'shortcut.app.general.zoom_reset': { enabled: true, key: ['CommandOrControl', '0'] },
    'shortcut.app.topic.new': { enabled: true, key: ['CommandOrControl', 'N'] },
    'shortcut.app.topic.rename': { enabled: true, key: ['CommandOrControl', 'T'] },
    'shortcut.app.topic.toggle_show_topics': { enabled: true, key: ['CommandOrControl', ']'] },
    'shortcut.feature.selection.get_text': { enabled: false, key: [] },
    'shortcut.feature.selection.toggle_enabled': { enabled: false, key: [] },
