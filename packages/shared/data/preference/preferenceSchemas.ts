 ...
 * Generated at: 2026-04-10T10:40:56.179Z
 *
...
export interface PreferenceSchemas {
  default: {
    ...
    'shortcut.general.show_mini_window': PreferenceTypes.PreferenceShortcutType
...
export const DefaultPreferences: PreferenceSchemas = {
  default: {
    ...
    'shortcut.general.exit_fullscreen': { enabled: true, key: ['Escape'] },
    'shortcut.general.search': { enabled: true, key: ['CommandOrControl', 'Shift', 'F'] },
    'shortcut.general.show_main_window': { enabled: true, key: [] },
    'shortcut.general.show_mini_window': { enabled: false, key: ['CommandOrControl', 'E'] },
    'shortcut.general.show_settings': { enabled: true, key: ['CommandOrControl', ','] },
    'shortcut.general.toggle_sidebar': { enabled: true, key: ['CommandOrControl', '['] },
    'shortcut.general.zoom_in': { enabled: true, key: ['CommandOrControl', '='] },
    'shortcut.general.zoom_out': { enabled: true, key: ['CommandOrControl', '-'] },
    'shortcut.general.zoom_reset': { enabled: true, key: ['CommandOrControl', '0'] },
