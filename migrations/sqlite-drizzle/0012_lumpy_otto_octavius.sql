...
INSERT INTO `__new_mcp_server` (
	`id`, `name`, `server_wire_name`, `type`, `description`, `base_url`, `command`, `registry_url`, `args`, `env`,
	`headers`, `provider`, `provider_url`, `logo_url`, `tags`, `long_running`, `timeout`, `dxt_version`, `dxt_path`,
	`reference`, `search_key`, `config_sample`, `disabled_tools`, `disabled_auto_approve_tools`, `should_config`,
	`sort_order`, `is_active`, `install_source`, `is_trusted`, `trusted_at`, `installed_at`, `created_at`, `updated_at`
)
SELECT
	`id`, `name`, `server_wire_name`, `type`, `description`, `base_url`, `command`, `registry_url`, `args`, `env`,
	`headers`, `provider`, `provider_url`, `logo_url`, `tags`, `long_running`, `timeout`, `dxt_version`, `dxt_path`,
	`reference`, `search_key`, `config_sample`, `disabled_tools`, `disabled_auto_approve_tools`, `should_config`,
	`sort_order`, `is_active`, `install_source`, `is_trusted`, `trusted_at`, `installed_at`, `created_at`, `updated_at`
FROM `mcp_server`;--> statement-breakpoint
