...
INSERT INTO `__new_agent_session`("id", "agent_id", "name", "description", "accessible_paths", "order_key", "created_at", "updated_at") SELECT "id", "agent_id", "name", COALESCE("description", '') AS "description", '[]' AS "accessible_paths", '' AS "order_key", "created_at", "updated_at" FROM `agent_session`;--> statement-breakpoint
...
--> statement-breakpoint
INSERT INTO `__new_agent`("id", "type", "name", "description", "instructions", "model", "plan_model", "small_model", "mcps", "allowed_tools", "configuration", "order_key", "created_at", "updated_at", "deleted_at") SELECT "id", "type", "name", "description", "instructions", "model", "plan_model", "small_model", "mcps", "allowed_tools", "configuration", '' AS "order_key", "created_at", "updated_at", "deleted_at" FROM `agent`;--> statement-breakpoint
