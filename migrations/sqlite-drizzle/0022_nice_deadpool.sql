...
INSERT INTO `__new_agent_session`("id", "agent_id", "name", "description", "order_key", "created_at", "updated_at") SELECT "id", "agent_id", "name", COALESCE("description", '') AS "description", '' AS "order_key", "created_at", "updated_at" FROM `agent_session`;--> statement-breakpoint
