...
--> statement-breakpoint
INSERT INTO `__new_agent_session`("id", "agent_type", "agent_id", "name", "description", "accessible_paths", "instructions", "model", "plan_model", "small_model", "mcps", "allowed_tools", "slash_commands", "configuration", "order_key", "created_at", "updated_at") SELECT "id", "agent_type", "agent_id", "name", "description", "accessible_paths", "instructions", "model", "plan_model", "small_model", "mcps", "allowed_tools", "slash_commands", "configuration", '' AS "order_key", "created_at", "updated_at" FROM `agent_session`;--> statement-breakpoint
...
CREATE INDEX `agent_session_agent_id_order_key_idx` ON `agent_session` (`agent_id`,`order_key`);