...
SELECT `session_id`, `channel_id`, NULL, NULL, false
FROM (
	SELECT
		`session_id`,
		`id` AS `channel_id`,
...
--> statement-breakpoint
INSERT INTO `__new_agent_channel_session` (`session_id`, `channel_id`, `conversation_id`, `conversation_kind`, `is_active`)
SELECT `session_id`, `channel_id`, `conversation_id`, `conversation_kind`, `is_active` FROM `agent_channel_session`;
--> statement-breakpoint
