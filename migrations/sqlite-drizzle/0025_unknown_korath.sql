...
-- Old agent_session has no order_key column; substitute the 'a0' constant.
-- AgentsMigrator.backfillAgentOrderKeys replaces it with real fractional keys when importing legacy v1 sessions.
