...
| T-006B | 文本选中捕获（block/message 上下文） | ✅ 代码完成 + 自动化校验过；⏳ commit | [T-006B_TextSelection/](./T-006B_TextSelection/) |
| T-006C | 扩展 SelectionContextMenu（加分支菜单项） | ⏳ | [T-006C_Menu/](./T-006C_Menu/) |
| T-006D | Branch Panel 组件 | ⏳ | [T-006D_BranchPanel/](./T-006D_BranchPanel/) |
