...
| **P1-S2b-2 精修步 — Multi-branch UI 视觉** | hover 联动；新分支 auto-scroll-into-view；凸起/斜角 folder-tab 视觉 + 动画；每卡发送中 loading 态 | 有 —— 体验细节 |
...
- [[P1-S2b-2_FollowupRouting/README|P1-S2b-2 follow-up 路由]] ✅ 2026-06-01（待 commit）
- P1-S2b-2 精修步 Multi-Branch UI 视觉（hover / auto-scroll / folder-tab 视觉 / 每卡 loading 态）— 未开始
